...
#include "Bomberman_LAB/Public/EnemigoAcuatico.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeEnemigoAcuatico() {}

// Begin Cross Module References
BOMBERMAN_LAB_API UClass* Z_Construct_UClass_AEnemigo();
BOMBERMAN_LAB_API UClass* Z_Construct_UClass_AEnemigoAcuatico();
BOMBERMAN_LAB_API UClass* Z_Construct_UClass_AEnemigoAcuatico_NoRegister();
...
template<> BOMBERMAN_LAB_API UClass* StaticClass<AEnemigoAcuatico>()
{
	return AEnemigoAcuatico::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_UnrealProjects_Bomberman_LAB_Source_Bomberman_LAB_Public_EnemigoAcuatico_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AEnemigoAcuatico, AEnemigoAcuatico::StaticClass, TEXT("AEnemigoAcuatico"), &Z_Registration_Info_UClass_AEnemigoAcuatico, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AEnemigoAcuatico), 4069506825U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_Bomberman_LAB_Source_Bomberman_LAB_Public_EnemigoAcuatico_h_979236306(TEXT("/Script/Bomberman_LAB"),
	Z_CompiledInDeferFile_FID_UnrealProjects_Bomberman_LAB_Source_Bomberman_LAB_Public_EnemigoAcuatico_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_Bomberman_LAB_Source_Bomberman_LAB_Public_EnemigoAcuatico_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
